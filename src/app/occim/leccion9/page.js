  ...
  return (
    ...
    <div className="bg-gray-100 min-h-screen px-4 py-6 sm:p-6">
      ...
      <div className="w-full mx-auto space-y-8">
        ...
        <h1 className="text-3xl font-bold text-center text-[#e79e00]">🎧 Lección 9 – No necesitas más fuerza de voluntad, necesitas sistemas</h1>
        ...
        <div className="w-full">
          ...
          >
            {/* Iframe del video de YouTube para la Lección 9. */}
            <iframe
              className="w-full h-full" // El iframe llenará el 100% del ancho y alto de su contenedor padre.
              src="https://www.youtube.com/embed/ibmmQdL8AhY" // URL del YouTube Short de la Lección 9
              title="Lección 9 – No necesitas más fuerza de voluntad, necesitas sistemas"
              frameBorder="0"
        ...
        <div className="border-t pt-8 mt-8">
          ...
          <div className="w-full h-[450px] sm:h-[550px] md:h-[650px] rounded-xl overflow-hidden shadow border">
            {/* Iframe del formulario de Google Forms para la Lección 9. */}
            <iframe
              src="https://docs.google.com/forms/d/e/1FAIpQLScc8kM4-bkl9fD9We6C_fCuLXlHDj1n2ixNUkqOc2tNZ2q8vA/viewform?usp=dialog&embedded=true" // URL de tu formulario de Lección 9
              width="100%"
              height="100%" // Asegura que el iframe ocupe todo el espacio de su div padre con altura controlada.
              frameBorder="0"
              marginHeight="0"
              marginWidth="0"
              title="Formulario Lección 9"
