  ...
  return (
    ...
    <div className="bg-gray-100 min-h-screen px-4 py-6 sm:p-6">
      ...
      <div className="w-full mx-auto space-y-8">
        ...
        <h1 className="text-3xl font-bold text-center text-[#e79e00]">🎧 Lección 10 – No eres flojo, estás saturado</h1>
        ...
        <div className="w-full">
          ...
          >
            {/* Iframe del video de YouTube para la Lección 10. */}
            <iframe
              className="w-full h-full" // El iframe llenará el 100% del ancho y alto de su contenedor padre.
              src="https://www.youtube.com/embed/ILql9GlK_3M" // URL del YouTube Short de la Lección 10
              title="Lección 10 – No eres flojo, estás saturado"
              frameBorder="0"
        ...
        <div className="border-t pt-8 mt-8">
          ...
          <div className="w-full h-[450px] sm:h-[550px] md:h-[650px] rounded-xl overflow-hidden shadow border">
            {/* Iframe del formulario de Google Forms para la Lección 10. */}
            <iframe
              // URL de tu formulario de Lección 10.
              src="https://docs.google.com/forms/d/e/1FAIpQLSesC4I8R-RSsUuodPBeS5U4HrIn1Tnk4KC14ZktNRqVFv6pbg/viewform?usp=dialog&embedded=true"
              width="100%"
              height="100%" // Asegura que el iframe ocupe todo el espacio de su div padre con altura controlada.
              frameBorder="0"
              marginHeight="0"
              marginWidth="0"
              title="Formulario Lección 10"
