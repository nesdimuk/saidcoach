...
<fieldset>
  <legend className="text-xl font-semibold mb-2 text-[#000000]">🏋️ 2. Experiencia con los entrenamientos</legend>
  ...
  <label className="block mb-2">Ejercicios favoritos
    <input type="text" name="favoritos" className="w-full mt-1 px-4 py-2 rounded bg-white" />
  </label>
  <label className="block mb-2">Ejercicios que no te gustan o desmotivan
    <input type="text" name="no_gustan" className="w-full mt-1 px-4 py-2 rounded bg-white" />
  </label>
  <label className="block">¿Qué aspectos podrían mejorar?
