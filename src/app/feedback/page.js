      ...
      <section className="max-w-3xl mx-auto animate-fade-up">
        ...
        >
          <div>
            ...
            <input type="text" name="nombre" required className="w-full p-3 rounded-lg" />
          </div>

          <div>
            <label className="block mb-1 font-semibold">Email</label>
            <input type="email" name="email" required className="w-full p-3 rounded-lg" />
          </div>

          <div>
            <label className="block mb-1 font-semibold">Fecha</label>
            <input type="date" name="fecha" required className="w-full p-3 rounded-lg" />
          </div>

          <div>
            <label className="block mb-1 font-semibold">Objetivo principal</label>
            <input type="text" name="objetivo" className="w-full p-3 rounded-lg" />
          </div>

          <div>
            <label className="block mb-1 font-semibold">Motivación</label>
            <input type="text" name="motivacion" className="w-full p-3 rounded-lg" />
          </div>

          <div>
            <label className="block mb-1 font-semibold">Desmotivación</label>
            <textarea name="desmotivacion" className="w-full p-3 rounded-lg" rows="2" />
          </div>

          <div>
            <label className="block mb-1 font-semibold">¿Qué ejercicio y/o grupos musculares te agrada trabajar?</label>
            <input type="text" name="favoritos" className="w-full p-3 rounded-lg" />
          </div>
          ...
          <div>
            ...
            <input type="text" name="seguimiento" className="w-full p-3 rounded-lg" />
          </div>
          ...
          <div>
            ...
            <select name="compromiso" className="w-full p-3 rounded-lg">
          ...
          <div>
            ...
            <input type="text" name="habito" className="w-full p-3 rounded-lg" />
          </div>

          <div>
            <label className="block mb-1 font-semibold">Mensaje final</label>
            <textarea name="libre" className="w-full p-3 rounded-lg" rows="3" />
          </div>
